    ...
    */
    ...
    for (const auto &arg_file : arg_files) {
        ...
        if (endswith(arg_file, ".f90") || endswith(arg_file, ".f") ||
            ...
            std::string tmp_o = std::filesystem::path(arg_file).
                replace_extension(".tmp.o").string();
            object_files.insert(object_files.begin(), tmp_o);
            ...
            object_files.push_back(arg_file);
        }
